...
export default {
    ...
    methods:{
        onSubmit(){
            ...
            this.userDetails = this.allUserList.find( user => user.username == this.form.username )
            // console.log(userDetails)
            if(this.form.username==this.userDetails.username && this.form.password == this.userDetails.password){
